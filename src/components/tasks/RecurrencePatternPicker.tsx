          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={(e) => setPattern(prev => ({ ...prev, businessDaysOnly: e.target.checked }))}
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500"
              />
              <label htmlFor="business-days-only" className="text-sm text-gray-700">
                Business days only (skip weekends)
              </label>
            </div>
            <p className="text-xs text-gray-500 -mt-2 ml-6">
              Task will only occur Monday through Friday
            </p>
          </div>
        )}
