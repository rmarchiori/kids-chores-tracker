      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2">{t('cards.todayTasks.title')}</h3>
            <p className="text-white/90 text-sm">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2">{t('cards.reviews.title')}</h3>
            <p className="text-white/90 text-sm">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2">{t('cards.completions.title')}</h3>
            <p className="text-white/90 text-sm">
          ...
          >
            ...
            <h3 className="text-xl font-bold mb-2">{t('cards.settings.title')}</h3>
            <p className="text-white/90 text-sm">
