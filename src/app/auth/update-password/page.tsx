    ...
    const checkSession = async () => {
      try {
        ...
        if (sessionError || !session) {
          setError('No active session found. Please click the reset link from your email.')
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-600 via-teal-700 to-cyan-800 px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          {/* No Valid Session */}
          {!isCheckingAuth && !hasValidSession && (
            <>
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <ul className="mt-2 ml-4 text-sm text-blue-700 list-disc space-y-1">
                  ...
                  <li>Use a fresh reset link (links expire after one use)</li>
                  <li>Request a new reset link if yours has expired</li>
                </ul>
              </div>
